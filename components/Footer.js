...
export function Footer () {
    ...
    return (
        <footer className="bg-gray-400 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:py-4 lg:px-5 lg:bg-black">
            <div>
            ...
            <div>
                ...
                <p className="text-md text-gray-700" >Umaru Musa Way, 
                    Asokoro
                </p>
            </div>
            <div>
                ...
                <ul className="flex lg:justify-end items-center gap-4">
                    <li><Link href="#"  className="text-sm text-gray-100">Glosary</Link></li>
                    <li><Link href="#" className="text-sm text-gray-100">Cookies</Link></li>
                    <li><Link href="#" className="text-sm text-gray-100">Pravacy policy</Link></li>
                </ul>
            </div>
        </footer>
    )
